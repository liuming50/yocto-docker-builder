...
[ -e /etc/shadow ] && sed -i 's%^ubuntu:.:%ubuntu::%' /etc/shadow
[ -e /etc/passwd ] && sed -i 's%^ubuntu:x:%ubuntu::%' /etc/passwd
...
sed -i "s#@@BUILD_DIR@@#$3#" /home/ubuntu/.bashrc
